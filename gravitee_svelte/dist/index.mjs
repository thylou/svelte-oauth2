import { SvelteComponent, init as init$2, safe_not_equal, handle_promise, empty, insert, update_await_block_branch, transition_in, transition_out, detach, create_slot, update_slot_base, get_all_dirty_from_scope, get_slot_changes, text, set_data, space, element, noop } from 'svelte/internal';
			...
			if (error_slot) {
				if (error_slot.p && (!current || dirty & /*$$scope, authentication*/ 17)) {
					update_slot_base(
						...
						: get_slot_changes(error_slot_template, /*$$scope*/ ctx[4], dirty, get_error_slot_changes),
...
function fallback_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*authentication*/ 1 && t0_value !== (t0_value = /*error*/ ctx[8].name + "")) set_data(t0, t0_value);
			if (dirty & /*authentication*/ 1 && t2_value !== (t2_value = /*error*/ ctx[8].message + "")) set_data(t2, t2_value);
		},
		d(detaching) {
			if (detaching) {
				detach(t0);
...
function create_then_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if ((!current || dirty & /*authentication*/ 1) && t0_value !== (t0_value = /*authOk*/ ctx[1](/*ok*/ ctx[7]) + "")) set_data(t0, t0_value);
...
function create_pending_block(ctx) {
	...
	const loading_slot = create_slot(loading_slot_template, ctx, /*$$scope*/ ctx[4], get_loading_slot_context);
			...
			if (loading_slot) {
				if (loading_slot.p && (!current || dirty & /*$$scope*/ 16)) {
					update_slot_base(
						...
						!current
						? get_all_dirty_from_scope(/*$$scope*/ ctx[4])
						: get_slot_changes(loading_slot_template, /*$$scope*/ ctx[4], dirty, get_loading_slot_changes),
...
function create_fragment(ctx) {
	...
	handle_promise(promise = /*authentication*/ ctx[0], info);
	...
	return {
		...
		p(new_ctx, [dirty]) {
			...
			if (dirty & /*authentication*/ 1 && promise !== (promise = /*authentication*/ ctx[0]) && handle_promise(promise, info)) ; else {
...
class Component extends SvelteComponent {
	constructor(options) {
		super();
		init$2(this, options, instance, create_fragment, safe_not_equal, { scopes: 2, authentication: 0 });
	}
}
...
const svelteKitStrategy = new class {
    ...
    async query() {
        ...
        return get(stores.page).url.searchParams;
    }
    getRedirection() {
...
export { AuthorizationCode, AuthorizationCodePKCE, ClientCredentials, addAuthHeader, browserStrategy, Component as default, init$1 as init, isAuthorized, runOAuth2Process, setCookieName, svelteKitStrategy };
