...
export const hasToken = async (): Promise<boolean> => {
    const tokenData: OAuthToken | undefined | null = (await oauthIntegration.tokenStorage()).get()
...
export const isAuthorized = async (scopes: Array<string>): Promise<boolean> => {
    const tokenData: OAuthToken | null | undefined = (await oauthIntegration.tokenStorage()).get()
